  ...
  static Future<http.Response?> getMethod(
    ...
    if (await CM.internetConnectionCheckerMethod()) {
      try {
        ...
        if (await CM.responseCheckForGetMethod(response: response)) {
  ...
  static Future<http.Response?> getMethodParams(
    ...
    if (await CM.internetConnectionCheckerMethod()) {
      try {
        ...
        if (kDebugMode) print("CALLING:: ${response.body}");
        if (await CM.responseCheckForGetMethod(
          response: response,
        )) {
          checkResponse?.call(response.statusCode);
          return response;
  ...
  static Future<http.Response?> postMethod(
    ...
    if (await CM.internetConnectionCheckerMethod()) {
      try {
        ...
        if (kDebugMode) print("CALLING:: ${response.body}");
        if (await CM.responseCheckForPostMethod(
  ...
  static Future<http.Response?> deleteMethod(
    ...
    if (await CM.internetConnectionCheckerMethod()) {
      try {
        ...
        if (kDebugMode) print("CALLING:: ${response.body}");
        if (await CM.responseCheckForPostMethod(response: response)) {
          checkResponse?.call(response.statusCode);
          return response;
        } else {
          checkResponse?.call(response.statusCode);
      ...
      void Function(int)? checkResponse}) async
  {
    ...
    if (await CM.internetConnectionCheckerMethod()) {
      try {
        ...
        if (await CM.responseCheckForPostMethod(response: res)) {
          checkResponse?.call(response.statusCode);
          return res;
        } else {
          checkResponse?.call(response.statusCode);
